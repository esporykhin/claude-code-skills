#!/bin/bash
# postings-fbo-list.sh — List FBO postings from Ozon Seller API
# Usage: ./postings-fbo-list.sh [since] [to] [status] [limit] [offset]
...
ozon_post "/v2/posting/fbo/list" "$PAYLOAD"
